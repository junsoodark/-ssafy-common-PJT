    ...
    > 
      ...
      <b-form @submit.prevent="signup">
        ...
        <b-input-group class="mb-3">
          ...
          <b-form-input type="text" v-model="nickname" required placeholder="이름"></b-form-input>
        </b-input-group>
        <!-- 비밀번호 -->
        <b-input-group class="mb-3">
          <b-input-group-prepend is-text>
        ...
        <b-input-group class="mb-3">
          ...
          <b-form-input type="number" v-model="age" required placeholder="나이"></b-form-input>
        </b-input-group>
        <!-- 성별 -->
        <b-input-group class="mb-5">
          ...
          <b-form-radio v-model="sex" type="number" name="some-radios" value="1" class="form-control text-center">남자</b-form-radio>
          <b-form-radio v-model="sex" type="number" name="some-radios" value="2" class="form-control text-center">여자</b-form-radio>
        ...
        <div>
          <b-form-checkbox 
            ...
            v-b-popover.hover="'이용 약관을 읽어주세요'" title="*주의*"
            >
        ...
        <b-button class="mt-2" type="submit" block variant="secondary">회원가입</b-button>
      </b-form>
    </div>
  </b-container>
</template>
