<template>
  <b-container>
    ...
    <div>
      ...
      <b-row>
        <b-table :no-border-collapse="true" :items="items" :fields="fields"></b-table>
      </b-row>
    </div>
    ...
    <b-modal id="my-modal">
      ...
      <template v-slot:modal-footer="{ ok, cancel }">
        ...
        <b-button size="sm" variant="danger" @click="deleteUserAccount(confirmPassword)">회원탈퇴</b-button>
        <b-button size="sm" variant="primary" @click="cancel()">취소</b-button>
      </template>
    </b-modal>
  </b-container>
</template>
  ...
  data() {
    return {
      ...
      items: [
        {
          상태: "요청 중",
          스터디명: "알고리즘 초급 스터디(코드 리뷰)",
          "진행 기간": "2020-03-01 ~ 2020-04-03",
          버튼: "요청취소",
        },
        {
          상태: "가입",
