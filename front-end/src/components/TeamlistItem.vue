  ...
  <b-container class="rounded p-2" style="cursor:pointer;" @click="clickCard">
    <div class="card">
      ...
      <div class="card-body text-center">
        <img
          :src="defaultImageUrl"
          style="width:140px;margin-top:-85px"
          alt="User"
          class="img-fluid img-thumbnail rounded-circle border-0 mb-2"
        />
        <b-row class="my-1">
          <b-col>
            <h5 class="font-weight-bold">{{ team.title }}</h5>
          </b-col>
        </b-row>
        <b-row class="my-1">
          ...
          <b-col md="8" offset-md="1" class="text-left">
            <b-badge pill variant="secondary" class="studyCard">서울 / 강남</b-badge>
          </b-col>
        </b-row>
        <b-row class="my-1">
          <b-col md="1" offset-md="1">
            <b-icon icon="calendar2-check-fill" font-scale="1"></b-icon>
          </b-col>
          <b-col md="8" offset-md="1" class="text-left">
            <b-badge pill variant="secondary" class="studyCard">추후 협의 / 2회</b-badge>
          </b-col>
        </b-row>
        <b-row class="my-1">
          <b-col md="1" offset-md="1">
            <b-icon icon="tv-fill" font-scale="1"></b-icon>
          </b-col>
          <b-col md="8" offset-md="1" class="text-left">
            <b-badge pill variant="secondary" class="studyCard">오프라인</b-badge>
          </b-col>
        </b-row>
      </div>
